...
@Slf4j
@Configuration
@EnableConfigurationProperties({JwtProperties.class, AdminOidcProperties.class, ExecutionArchiveProperties.class, AgentProfileProbeProperties.class, LearningCycleProperties.class, AdminObservabilityProperties.class, ZestFlowAdminProperties.class})
